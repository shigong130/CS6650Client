...
//        Worker wk = new Worker("1",10,3,4,5,6,7,8, null,
//                new AtomicInteger(0), new AtomicInteger(0), new ArrayList<HttpRecord>(), "http://52.23.184.215:8080/SkiResortsServer_war/");
//        new Thread(wk).start();
//    }
}
